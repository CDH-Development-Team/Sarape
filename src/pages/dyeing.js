...
import { GeographyContainer, MosaicWrapper, MosaicImg, HeaderText, GeographyEntry, GeographyEntryText, GeographyEntryImg, GeographyEntryDescription, GeographyStatues, Statue, StatueImg, BackgroundDiv, BackgroundContentLeft, BackgroundContentRight, BackgroundImg, HistoryMosaicParent, HistoryMosaicParent2,
    HistoryMosaic22, HistoryMosaic23, HistoryMosaic24, HistoryMosaic25, HistoryMosaic26, HistoryMosaic27, HistoryMosaic28, HistoryMosaic29, HistoryMosaic30, HistoryMosaic31,HistoryMosaic32} from '../components/Geography/geographyElements.js';
// import Color1 from '../images/section 2/color1.png'
import "../components/Geography/geography.css";
import useWindowDimensions from '../components/Geography/dimensions';
import { DyeMosaicParent, DyeMosaic1, DyeMosaic2, DyeMosaic3, DyeMosaic4, DyeMosaic5, DyeMosaic6, DyeMosaic7, DyeMosaic8, DyeMosaic9, DyeMosaic10, DyeMosaic11, DyeMosaic12, DyeMosaic13, DyeMosaic14, DyeMosaic15, DyeMosaic16, DyeMosaic17, DyeMosaic18, DyeMosaic19, DyeMosaic20 } from '../components/Geography/geographyElements.js';
...
const DyeingPage = () => {
 ...
 <GeographyContainer>
     <DyeMosaicParent height={(width-(width%16))/16*8} width={(width-(width%16))}>
        ...
        <img src={Icon3}width={"100%"} onClick={() => {
          setContent(
        ...
        <img src={Icon9} height={"100%"} width={"100%"} onClick={() => {
          setContent(
        ...
        <img src={Icon15} height={"100%"} width={"100%"} onClick={() => {
          setContent();
          openModal();
        }}></img>
        </DyeMosaic15>
