...
export const homeObjOne = {
    ...
    buttonLabel: "",
    cap:"Porfirio Gutiérrez.",
    cap2:"Joe Coca, photographer, 2019",
    imgStart: false,
    img: img,
    alt: 'Car',
    dark: true,
...
export const homeObjThree = {
    ...
    description: "Get everything set uo and ready in under 10 minutes. All you need to do is add your information and you're ready to go.",
...
export const homeObjFour = {
    ...
    description3: "An early colonial weaving workshop with Indigenous men weaving and spinning while a Spanish official oversees them. The loom combines elements of both the backstrap and treadle looms.",
    buttonLabel: "",
    imgStart: false,
    img: img4,
    alt: 'Car',
